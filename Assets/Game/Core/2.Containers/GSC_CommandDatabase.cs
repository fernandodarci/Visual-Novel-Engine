...
public class GSC_CommandDatabase
{
    ...
    public GSC_CommandDatabase AddCommand(string commandName,Func<GSC_ContainerUnit,IEnumerator> func)
    {
        GSC_CommandHandler handler = new GSC_CommandHandler(func, null);
        return AddCommand(commandName, handler);
    }

    public GSC_CommandDatabase AddCommand(string commandName, Func<GSC_ContainerUnit, IEnumerator> func, Action<GSC_ContainerUnit> action)
    {
