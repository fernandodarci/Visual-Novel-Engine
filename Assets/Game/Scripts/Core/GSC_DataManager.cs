...
public class GSC_DataManager : GSC_Singleton<GSC_DataManager>
{
    ...
    public void Operate(bool system, string keyToOperate, bool value)
    {
    ...
    public void Operate(bool system, string keyToOperate, string value)
    {
        AddOrChangeValue(keyToOperate, value, system);
    }

    public void Switch(bool system, string KeyToOperate)
    {
        if (system) SystemData.Switch(KeyToOperate);
        else CurrentSaveData.Switch(KeyToOperate);
    }
